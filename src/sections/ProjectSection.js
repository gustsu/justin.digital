    ...
    <div className="project-section pos-rel" id="project-section">
        <Container>
            ...
            <Project 
              ...
              desc="JNT Creative LLC is my personal Web Design Business. Founded in 2017 JNT Creative works with small businesses and locals to create Websites, Mobile Apps, and more."
              reverse
            />
            <Project 
              name="30 Days Of Vue"
            ...
            <Project
              ...
              desc="Spoon &amp; Leaf is a ficitonal Matcha Green Tea company created by myself and my wife as an exercise in working with Woocommerce, one of the biggest ecommerce Wordpress plugins in the world. This also served as a gateway into using prebuild wordpress themes to quickly produce a good looking website."
            />
            <Project 
              name="Ralph Tew Art"
